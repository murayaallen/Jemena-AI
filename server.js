...
app.post('/chat', async (req, res) => {
  try {
    ...
    if (productMatch) {
      ...
      // Always include availability confirmation
      const availability = `✅ Available at Jemena Trading\n📦 Packaging Sizes: ${details.packaging.join(', ')}`;
    ...
    const generalPrompt = `As a chemical expert at Jemena Trading, answer: "${userMessage}". Include:
      - Key applications
      - Safety considerations
      - Industry relevance
      - Relation to our product portfolio
